...
window.CONFIG = {
  ...
  /* -----------------------------------------------------------
     ...
     ----------------------------------------------------------- */
  photos: {
    hero:   'img/hero.jpg',      // ձախ լուսանկարը — ուղղահայաց, 4:5
    story1: 'img/story-1.jpg',   // միջին լուսանկարը — ուղղահայաց, 4:5
    story2: 'img/story-2.jpg'    // աջ լուսանկարը — ուղղահայաց, 4:5
  }
};
